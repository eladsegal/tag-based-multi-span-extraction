...
@Model.register("nabert++V2")
class NumericallyAugmentedBERTPlusPlusV2(Model):
    """
    ...
    def __init__(self, 
        ...
        if answering_abilities is None:
            self.answering_abilities = ["arithmetic", "counting", "multiple_spans"]
        else:
...
#             arithmetic_summary = self.summary_vector(question_out, question_mask, "arithmetic")
        ...
        if answer_as_passage_spans is not None or answer_as_question_spans is not None \
            ...
            for answering_ability in self.answering_abilities:
                if answering_ability == "arithmetic":
                    if self.arithmetic == "base":
        ...
        with torch.no_grad():
            ...
            if metadata is not None:
                ...
                for i in range(batch_size):
                    ...
                    if predicted_ability_str == "arithmetic":  # plus_minus combination answer
